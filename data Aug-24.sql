...
CREATE TABLE IF NOT EXISTS `orders` (
  ...
  `payment_status` int(11) DEFAULT '0' COMMENT 'Trạng thái đơn hàng',
  `delivery_status` int(11) DEFAULT '0' COMMENT 'Trạng thái vận chuyển',
  PRIMARY KEY (`id`)
...
INSERT INTO `orders` (`id`, `user_id`, `order_code`, `date_created`, `payment_status`, `delivery_status`) VALUES
	(1, 2, 'DONHANG_1', '2020-08-24 23:30:29', 1, 1),
	(2, 2, 'DONHANG_2', '2020-08-24 23:38:19', 0, 0);
...
CREATE TABLE IF NOT EXISTS `order_detail` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='Chi tiết đơn hàng';

-- Dumping data for table locknlock.order_detail: 3 rows
