...
INSERT INTO `categories` (`id`, `name`, `description`, `url_img`, `parentId`, `isFrontPage`) VALUES
	(1, 'Hộp bảo quản', NULL, NULL, NULL, 'N'),
	(2, 'Dụng cụ nấu ăn', NULL, NULL, NULL, 'N'),
	(3, 'Đồ dùng trên bàn', NULL, NULL, NULL, 'N'),
	(4, 'Đồ dùng dã ngoại', NULL, NULL, NULL, 'N'),
	(5, 'Bình giữ nhiệt/ Giữ lạnh', NULL, NULL, NULL, 'N'),
	(6, 'Hàng gia dụng', NULL, NULL, NULL, 'N'),
	...
	(29, 'Bình nước', NULL, NULL, 4, 'N'),
	(30, 'Hộp cơm', NULL, NULL, 4, 'N'),
...
-- Dumping data for table locknlock.products: ~2 rows (approximately)
DELETE FROM `products`;
/*!40000 ALTER TABLE `products` DISABLE KEYS */;
INSERT INTO `products` (`id`, `name`, `description`, `price`, `postID`, `categoryID`, `thumbnail_url`) VALUES
	(1, 'Bộ 3 hộp thủy tinh L&L Euro (LLG214*2, LLG224*1)', NULL, 570000, 0, 11, '1.jpg'),
	...
	(7, 'Chảo nhôm sâu lòng chống dính BAUM Marble 28cm, 1 tay cầm, nắp thủy tinh, hiệu L&L', NULL, 669000, 0, 15, '6.jpg'),
