                    ...
                    <div class="col-md-2 col-sm-12">
                        <div class="pl-2" id="wrapper">
                            ...
                            <div class="my-3" id="image-holder">
                                <img class="thumb-image" src="../img/products/<?= $data['product']['thumbnail_url'] ?>"
                                    alt="" srcset="">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 col-sm-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <input name='name' value='<?= $data['product']['name'] ?>' type="text"
                                ...
                                <div class="form-group">
                                    ...
                                    <select name='categoryId' class="form-control input-square" id="squareSelect">
                                        ...
                                        <option value='<?= $value['id'] ?>'
                                            <?= $value['id'] == $data['product']['categoryId'] ? 'selected' : '' ?>>
                        ...
                        <div class="row">
                            <div class="col-md-6 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input name='description' value='<?= $data['product']['description'] ?>' type="text"
                                        class="form-control input-square" id="squareInput"
                                        placeholder="Nhập mô tả sản phẩm (màu sắc, trọng lượng, phụ kiện kèm theo)">
                                </div>
                            </div>
                            <div class="col-md-6 col-sm-12">
                                <div class="form-group">
                                    <label for="squareInput">Giá</label>
                                    <input name='price' value='<?= $data['product']['price'] ?>' type="number"
                                        class="form-control input-square" id="squareInput"
                    ...
                    <div class="col-md-10 col-sm-12">
                        <div class="form-group">
                            ...
                            <textarea name="editor1"
                                id='postContentInput'><?=$data['post'] == null?'<h1>Thêm bài viết mới giới thiệu về sản phẩm</h1>':$data['post']['content']?></textarea>
                        </div>
                    </div>
                </div>
                <div class="card-action d-flex justify-content-end">
                    <button type="submit" class="btn btn-success mx-1"><i class="la la-save"></i> Lưu</button>
                    <a href='products.php<?=isset($data['return'])?('?'.$data['return']):''?>'
                        class="btn btn-danger mx-1"><i class="la la-times"></i> Huỷ</a>
                </div>
            </div>
        </form>
    </div>
