                ...
                <div>
                    <div class="form-check">
                        <label class="form-check-label">
                            <input class="form-check-input" type="checkbox" value="" <?= $data['category']['isFrontPage'] == 'Y' ? 'checked' : '' ?>>
                    ...
                    <div class="pl-2" id="wrapper">
                        ...
                        <div class="my-3" id="image-holder">
                            <img class="thumb-image" src="../img/categories/<?= $data['category']['url_img'] ?>" alt="" srcset="">
                        </div>
                    </div>
