...
-- Dumping data for table locknlock.categories: ~30 rows (approximately)
...
-- Dumping structure for table locknlock.master_data
DROP TABLE IF EXISTS `master_data`;
CREATE TABLE IF NOT EXISTS `master_data` (
  `group` varchar(50) NOT NULL,
  `code` varchar(50) NOT NULL,
  `name` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`code`,`group`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

-- Dumping data for table locknlock.master_data: ~8 rows (approximately)
DELETE FROM `master_data`;
/*!40000 ALTER TABLE `master_data` DISABLE KEYS */;
INSERT INTO `master_data` (`group`, `code`, `name`) VALUES
	('HINHTHUCTHANHTOAN', 'CC', 'Thẻ tín dụng/Thẻ ghi nợ'),
	('TRANGTHAITHANHTOAN', 'CHUATHANHTOAN', 'Chưa thanh toán'),
	('HINHTHUCTHANHTOAN', 'COD', 'Thanh toán lúc khi nhận hàng'),
	('TRANGTHAIVANCHUYEN', 'DAGIAOHANG', 'Đã giao hàng'),
	('TRANGTHAIVANCHUYEN', 'DANGVANCHUYEN', 'Đang vận chuyển'),
	('TRANGTHAITHANHTOAN', 'DATHANHTOAN', 'Đã thanh toán'),
	('HINHTHUCTHANHTOAN', 'EBANKING', 'Chuyển khoản trực tuyến'),
	('HINHTHUCTHANHTOAN', 'MOMO', 'Ví điện tử Momo'),
	('TRANGTHAIVANCHUYEN', 'TAIKHO', 'Tại kho'),
	('TRANGTHAIVANCHUYEN', 'TRAHANG', 'Đổi/trả sản phẩm');
/*!40000 ALTER TABLE `master_data` ENABLE KEYS */;

-- Dumping structure for table locknlock.orders
DROP TABLE IF EXISTS `orders`;
CREATE TABLE IF NOT EXISTS `orders` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` int(11) DEFAULT NULL,
  `order_code` varchar(50) DEFAULT NULL,
  `date_created` timestamp NULL DEFAULT current_timestamp() COMMENT 'Ngày giờ khởi tạo đơn hàng',
  `payment_status` varchar(50) DEFAULT NULL COMMENT 'Trạng thái đơn hàng',
  `payment_method` varchar(50) DEFAULT NULL,
  `delivery_status` varchar(50) DEFAULT NULL COMMENT 'Trạng thái vận chuyển',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='Đơn hàng';

-- Dumping data for table locknlock.orders: 2 rows
DELETE FROM `orders`;
/*!40000 ALTER TABLE `orders` DISABLE KEYS */;
INSERT INTO `orders` (`id`, `user_id`, `order_code`, `date_created`, `payment_status`, `payment_method`, `delivery_status`) VALUES
	(1, 2, 'DONHANG_1', '2020-08-24 23:30:29', 'DATHANHTOAN', 'CC', 'TAIKHO'),
	(2, 2, 'DONHANG_2', '2020-08-24 23:38:19', 'CHUATHANHTOAN', NULL, 'DANGVANCHUYEN');
/*!40000 ALTER TABLE `orders` ENABLE KEYS */;

-- Dumping structure for table locknlock.order_detail
DROP TABLE IF EXISTS `order_detail`;
CREATE TABLE IF NOT EXISTS `order_detail` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `order_id` int(11) NOT NULL COMMENT 'ID đơn hàng',
  `product_id` int(11) NOT NULL,
  `product_price` int(11) NOT NULL COMMENT 'Giá bán sản phẩm',
  `product_quantity` int(11) NOT NULL DEFAULT 1 COMMENT 'Số lượng sản phẩm',
  `discount` int(11) NOT NULL DEFAULT 0 COMMENT 'giảm giá',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 COMMENT='Chi tiết đơn hàng';

-- Dumping data for table locknlock.order_detail: 5 rows
DELETE FROM `order_detail`;
/*!40000 ALTER TABLE `order_detail` DISABLE KEYS */;
INSERT INTO `order_detail` (`id`, `order_id`, `product_id`, `product_price`, `product_quantity`, `discount`) VALUES
	(1, 1, 1, 570000, 1, 0),
	(2, 1, 5, 95000, 1, 0),
	(3, 1, 12, 350000, 2, 0),
	(4, 2, 1, 570000, 5, 0),
...
INSERT INTO `products` (`id`, `name`, `description`, `unit`, `price`, `postID`, `categoryID`, `thumbnail_url`, `created`) VALUES
	(1, 'Bộ 3 hộp thủy tinh L&L Euro', 'LLG214*2, LLG224*1', 'Bộ', 570000, 0, 11, '1.jpg', '2020-07-10 13:41:25'),
	(2, 'HPL550- Hộp bảo quản gạo bằng nhựa Lock&Lock 12kg', NULL, 'Bộ', 290000, 0, 11, '2.jpg', '2020-07-11 12:41:26'),
	(3, 'Hộp nhựa L&L Twist Two way 760ml+310ml - Nắp màu đỏ', NULL, 'Bộ', 99000, 0, 12, '3.jpg', '2020-07-11 09:41:26'),
	(5, 'Hộp nhựa L&L Twist Two way 560ml+310ml - Nắp màu đỏ', NULL, 'Bộ', 95000, 0, 12, '4.jpg', '2020-07-10 14:41:27'),
	(6, 'Chảo nhôm sâu lòng chống dính BAUM Marble 30cm, 1 tay cầm, nắp thủy tinh, hiệu L&L', NULL, 'Chiếc', 759000, 0, 15, '5.jpg', '2020-06-11 14:41:28'),
	(7, 'Chảo nhôm sâu lòng chống dính BAUM Marble 28cm, 1 tay cầm, nắp thủy tinh, hiệu L&L', NULL, 'Chiếc', 669000, 1, 15, '6.jpg', '2020-05-11 14:41:29'),
	(8, 'Nồi nhôm chống dính BAUM Marble 24cm, 2 tay cầm, nắp thủy tinh, hiệu L&L', NULL, 'Chiếc', 749000, 0, 16, '7.jpg', '2020-07-16 14:41:29'),
	(9, 'Bộ nồi ZEN COOK BALLOON bằng sứ', '2 cái nồi + 2 cái nắp', 'Bộ', 2000000, 0, 16, '8.jpg', '2020-07-11 06:41:30'),
	(10, 'Bộ 3 Tô Trộn Thủy Tinh Chịu Nhiệt Boroseal Lock&Lock ', 'LLG013S3 (1.5L / Tô)', 'Bộ', 589000, 0, 18, '9.jpg', '2020-07-12 06:41:31'),
	(11, 'CKK101S5BLK - Bộ dao nhà bếp 5 món COOKPLUS Lock & Lock', 'Dao: 4 cái ; Dụng cụ gọt vỏ trái cây: 1 cái', 'Bộ', 250000, 0, 21, '10.jpg', '2020-05-11 10:41:32'),
	(12, 'Bộ 2 thớt gỗ cây cao su', '1 thớt hình chữ nhật + 1 thớt ping pong', 'Bộ', 350000, 0, 22, '11.jpg', '2020-03-11 08:41:32');
